var cadastro = {
    ...
    successedRegister: function (githubUser){
        ...
        formArea.innerHTML = '<div class="alert alert-success">Cadastro efetuado com sucesso!</div>' + 
            '<p class="text-left w-100">dierecionando para a tela inicial</p>';
        setTimeout(() => window.location = 'filme.html', 2000);
    },
        ...
        return {
            ...
            isValid: function(){
                ...
                if(this.passwordConfirmation === '')
                    this.errors.push('Digite a sua senha novamente');
                if(this.password !== this.passwordConfirmation)
                    this.errors.push('As senhas e nao sao iguais');
